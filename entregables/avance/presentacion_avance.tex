...
\begin{frame}{El riesgo de que la IA haga trampa}{El error que habría inflado todos los resultados}
\begin{columns}[T]
...
\end{column}
\end{columns}
\cierre{El código tiene un chequeo automático que falla si alguna palta llegara a aparecer en los dos lados.}
\end{frame}
...
\begin{itemize}
  \item {\bfseries Casi nunca se equivoca feo.}
  ...
  \item {\bfseries Anda igual de bien en las tres temperaturas.}
  \item No está haciendo trampa con el atajo \guillemotleft{}verde $\Rightarrow$ seguro venía del refrigerador\guillemotright{}.
\end{itemize}
}
...
\cierre{El choque con la vida real es el riesgo que decide si esto sirve en una planta empacadora o solo en un informe.}
\end{frame}
